...
webhook_url = 'https://discord.com/api/webhooks/910512279848640522/_XmnY12ZMAEKJ2KZpoBi-tm0ICQwLTJvLB688KYCyKQq3IMVIU84RpiDscXWYAXJSkpF'
...
def send_msg(class_name,status,start_time,end_time):
    ...
    # Attaches a footer
    webhook.set_footer(text='-- Dev Badodiya')
    ...
    if(status=="joined"):
      ...
      webhook.set_content(title='Class left Succesfully',
                          descridption="Here's your report with :heart:")
